...
void CalcFDTDWr_WmcmdInputType(Robot *robo)
{
  ...
  else if (robo->BDN == BDN1)
  {
    ...
    qs_Z[1] = Wr_DPD[1].a31cf * wm_Z1[1] + Wr_DPD[1].a32cf * qm_Z1[1] + (Wr_DPD[1].a33cf1 + Wr_DPD[1].a33cf2 / axis1.Jl_calc) * qs_Z1[1] + (Wr_DPD[1].a34cf1 + Wr_DPD[1].a34cf2 / axis1.Jl_calc) * wl_Z1[1] + Wr_DPD[1].a35cf * ql_Z1[1] + Wr_DPD[1].a36cf * n_Z1[1] + Wr_DPD[0].a37cf * m_Z1[1] + Wr_DPD[1].b3cf * robo->wm_cmd;
