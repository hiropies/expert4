...
void CalcFDTDWr_WmcmdInputType(Robot *robo)
{
  ...
  else if (robo->BDN == BDN2)
  {
    ...
    qs_Z[2] = Wr_DPD[2].a31cf * wm_Z1[2] + Wr_DPD[2].a32cf * qm_Z1[2] + (Wr_DPD[2].a33cf1 + Wr_DPD[2].a33cf2 / axis1.Jl_calc) * qs_Z1[0] + (Wr_DPD[2].a34cf1 + Wr_DPD[2].a34cf2 / axis1.Jl_calc) * wl_Z1[2] + Wr_DPD[2].a35cf * ql_Z1[2] + Wr_DPD[2].a36cf * n_Z1[2] + Wr_DPD[2].a37cf * m_Z1[2] + Wr_DPD[2].b3cf * robo->wm_cmd;
