...
volatile float WAVE_tauLwoG1; // [Nm] 動力学外乱トルク 重力項なし
volatile float WAVE_tauLwoG2; // [Nm] 動力学外乱トルク 重力項なし
volatile float WAVE_tauLwoG3; // [Nm] 動力学外乱トルク 重力項なし
// 動力学によるJl計算値
...
typedef volatile struct Robot
{
  ...
  // 動力学計算結果
  float tauLdyn_woG;
  float tauLdyn_woG_z1;
  float tauLdyn_woG_z2;
  float tauLdyn_woG_z3;
...
interrupt void ControlFunction(void)
{
        ...
        */
        ...
        if (2 == flag_cont_start)
        {
          ...
          ***************************************************************************** */
          ...
          {
            // 2軸目 速度PI制御＋SFB＋FF
            axis2.IrefQ = velocity[1].PIcontroller(axis2.wm_ref - axis2.wm, axis2.Kvp, axis2.Kvi, Tp, &velocity[1].uZ1, &velocity[1].yZ1) - axis2.Isfb + axis2.Iff + axis2.Icmp;
            axis2.I_SOBinput = velocity[1].PIcontroller(axis2.wm_ref - axis2.wm, axis2.Kvp, axis2.Kvi, Tp, &velocity[1].uZ1, &velocity[1].yZ1) - axis2.Isfb + axis2.Icmp;
            ...
            {
              axis2.I_SOBinput = velocity[1].PIcontroller(axis2.wm_ref - axis2.wm, axis2.Kvp, axis2.Kvi, Tp, &velocity[1].uZ1, &velocity[1].yZ1) - axis2.Isfb + axis2.Iff + axis2.Icmp;
            }
          }
          else if (flag_FF == 0)
          {
            // 2軸目 速度PI制御＋SFB
            axis2.IrefQ = velocity[1].PIcontroller(axis2.wm_ref - axis2.wm, axis2.Kvp, axis2.Kvi, Tp, &velocity[1].uZ1, &velocity[1].yZ1) - axis2.Isfb + axis2.Icmp;
          ...
          {
            // 3軸目 速度PI制御＋SFB＋FF
            axis3.IrefQ = velocity[2].PIcontroller(axis3.wm_ref - axis3.wm, axis3.Kvp, axis3.Kvi, Tp, &velocity[2].uZ1, &velocity[2].yZ1) - axis3.Isfb + axis3.Iff + axis3.Icmp;
            ...
            if (flag_SOB == 1)
            {
              axis3.I_SOBinput = velocity[2].PIcontroller(axis3.wm_ref - axis3.wm, axis3.Kvp, axis3.Kvi, Tp, &velocity[2].uZ1, &velocity[2].yZ1) - axis3.Isfb + axis3.Icmp;
            }
            else if (flag_SOB == 2)
            {
              axis3.I_SOBinput = velocity[2].PIcontroller(axis3.wm_ref - axis3.wm, axis3.Kvp, axis3.Kvi, Tp, &velocity[2].uZ1, &velocity[2].yZ1) - axis3.Isfb + axis3.Iff + axis3.Icmp;
            }
          }
          else if (flag_FF == 0)
          {
  ...
  WAVE_tauLwoG1 = axis1.tauLdyn_woG;
  WAVE_tauLwoG2 = axis2.tauLdyn_woG;
  WAVE_tauLwoG3 = axis3.tauLdyn_woG;
...
void StateObserver(float Iref, float wM, volatile float *est_wM, volatile float *est_Qs, volatile float *est_wL, int BDN)
{
  ...
  // A行列
  const double a1_11 = 0.860036430344327;
  const double a1_12 = -276.463329905868;
  const double a1_13 = 0.0442374110236822;
  const double a1_21 = 2.2484e-5;
  const double a1_22 = 0.9996;
  const double a1_23 = -3.1994e-4;
  const double a1_31 = -7.6004e-4;
  const double a1_32 = 0.7838;
  const double a1_33 = 0.9998;
  // B行列
  const double b1_11 = 0.1059;
  const double b1_12 = 0.1395;
  const double b1_21 = 1.1103e-7;
  const double b1_22 = -2.0388e-5;
  const double b1_31 = 2.9013e-8;
  const double b1_32 = 7.6086e-4;

  // 2軸目SOB　
  // 初期姿勢：2軸目0.0deg,3軸目0.0deg JL = 23.9
  const double a2_11 = 0.8606;
  const double a2_12 = -565.4194;
  const double a2_13 = 0.0905;
  const double a2_21 = 1.0549e-5;
  const double a2_22 = 0.9992;
  const double a2_23 = -3.1989e-4;
  const double a2_31 = -2.2348e-4;
  const double a2_32 = 1.3847;
  const double a2_33 = 0.9997;
  // B行列
  const double b2_11 = 0.1249;
  const double b2_12 = 0.1385;
  const double b2_21 = 1.3222e-7;
  const double b2_22 = -8.4332e-6;
  const double b2_31 = 6.1054e-8;
  const double b2_32 = 2.2495e-4;
  /*
  ...
  */
  ...
  // 3軸目SOB　
  // A行列
  const double a3_11 = 0.8638;
  const double a3_12 = -2.1679e3;
  const double a3_13 = 0.3471;
  const double a3_21 = 2.0482e-6;
  const double a3_22 = 0.9967;
  const double a3_23 = -3.1961e-4;
  const double a3_31 = 1.7050e-4;
  const double a3_32 = 5.0444;
  const double a3_33 = 0.9989;
  // B行列
  const double b3_11 = 0.6435;
  const double b3_12 = 0.1330;
  const double b3_21 = 7.3576e-7;
  const double b3_22 = 2.3411e-7;
  const double b3_31 = 1.2389e-6;
  const double b3_32 = -1.6474e-4;
...
void FDTD_Tm_woG(Robot *robo)
{
  ...
  if (robo->BDN == BDN0)
  {
    y_0 = 1.0 / Tm_sub[0].den_2 * (Tm_sub[0].num_2 * robo->tauLdyn_woG + Tm_sub[0].num_1 * uZ1_0 + Tm_sub[0].num_0 * uZ2_0);
    robo->Iff = y_0;
    a_0 = uZ1_0;
    uZ1_0 = robo->tauLdyn_woG;
    uZ2_0 = a_0;
  }
  else if (robo->BDN == BDN1)
  {
    y_1 = 1.0 / Tm_sub[1].den_2 * (Tm_sub[1].num_2 * robo->tauLdyn_woG + Tm_sub[1].num_1 * uZ1_1 + Tm_sub[1].num_0 * uZ2_1);
    robo->Iff = y_1;
    a_1 = uZ1_1;
    uZ1_1 = robo->tauLdyn_woG;
    uZ2_1 = a_1;
  }
  else if (robo->BDN == BDN2)
  {
    y_2 = 1.0 / Tm_sub[2].den_2 * (Tm_sub[2].num_2 * robo->tauLdyn_woG + Tm_sub[2].num_1 * uZ1_2 + Tm_sub[2].num_0 * uZ2_2);
    robo->Iff = y_2;
    a_2 = uZ1_2;
    uZ1_2 = robo->tauLdyn_woG;
    uZ2_2 = a_2;
  }
}
...
void FDTD_Tm_Full_woG(Robot *robo)
{
  ...
  if (robo->BDN == BDN0)
  {
    y_0 = (-Tm_full_sub[0].den_2 * yZ1_0 + Tm_full_sub[0].num_3 * robo->tauLdyn_woG + Tm_full_sub[0].num_2 * uZ1_0 + Tm_full_sub[0].num_1 * uZ2_0 + Tm_full_sub[0].num_0 * uZ3_0) / Tm_full_sub[0].den_3;
    robo->Iff = y_0;
    yZ1_0 = robo->Iff;
    uZ3_0 = uZ2_0;
    uZ2_0 = uZ1_0;
  ...
  {
    y_0 = (-Tm_full_sub[1].den_2 * yZ1_1 + Tm_full_sub[1].num_3 * robo->tauLdyn_woG + Tm_full_sub[1].num_2 * uZ1_1 + Tm_full_sub[1].num_1 * uZ2_1 + Tm_full_sub[1].num_0 * uZ3_1) / Tm_full_sub[1].den_3;
    robo->Iff = y_0;
    yZ1_1 = robo->Iff;
    uZ3_1 = uZ2_1;
    uZ2_1 = uZ1_1;
  ...
  {
    y_0 = (-Tm_full_sub[2].den_2 * yZ1_2 + Tm_full_sub[2].num_3 * robo->tauLdyn_woG + Tm_full_sub[2].num_2 * uZ1_2 + Tm_full_sub[2].num_1 * uZ2_2 + Tm_full_sub[2].num_0 * uZ3_2) / Tm_full_sub[2].den_3;
    robo->Iff = y_0;
    yZ1_2 = robo->Iff;
    uZ3_2 = uZ2_2;
    uZ2_2 = uZ1_2;
...
void FDTD_Tm_Full_Init()
{
  ...
  Tm_full_sub[0].den_1 = 0.0;
  Tm_full_sub[0].den_0 = 0.0;
  Tm_full_sub[0].num_3 = 1.0;
  Tm_full_sub[0].num_2 = -3.0 + Tm_full_sub[0].a02 * Tp + Tm_full_sub[0].a01 * Tp * Tp;
  Tm_full_sub[0].num_1 = 3.0 - 2 * Tm_full_sub[0].a02 * Tp - Tm_full_sub[0].a01 * Tp * Tp + Tm_full_sub[0].a00 * Tp * Tp * Tp;
  ...
  Tm_full_sub[1].den_1 = 0.0;
  Tm_full_sub[1].den_0 = 0.0;
  Tm_full_sub[1].num_3 = 1.0;
  ...
  Tm_full_sub[2].den_1 = 0.0;
  Tm_full_sub[2].den_0 = 0.0;
  Tm_full_sub[2].num_3 = 1.0;
...
void CalcInverseCmd_vel(float goal[3], float vel_hand[3], float ql_cmd[3], float wl_cmd[3], float ql_init[3], int flag_reset)
{
  ...
  float S3 = sin(joint[2]);
  float C3 = cos(joint[2]);
...
void CalcPVGain(void)
{
  ...
  axis1.av4 = 1;                    
  axis1.av3 = (axis1.Rgn * axis1.Rgn * (axis1.Ktn * axis1.Jl_calc * (axis1.fwm + axis1.Kvp)) + axis1.Jmn * axis1.Dln + axis1.Jl_calc * axis1.Dmn) / (axis1.Rgn * axis1.Rgn * axis1.Jl_calc * axis1.Jmn);
  axis1.av2 = (axis1.Rgn * axis1.Rgn * axis1.Ktn * (axis1.Dln * axis1.fwm + axis1.Dln * axis1.Kvp + axis1.Jl_calc * axis1.Kvi) + axis1.Rgn * axis1.Ktn * axis1.Jl_calc * axis1.fqs + axis1.Jl_calc * axis1.Ksn + axis1.Rgn * axis1.Rgn * (axis1.Jmn * axis1.Ksn + axis1.Dmn * axis1.Dln)) / (axis1.Rgn * axis1.Rgn * axis1.Jl_calc * axis1.Jmn);
  axis1.av1 = (axis1.Rgn * axis1.Rgn * axis1.Ktn * (axis1.Ksn * axis1.fwm + axis1.Ksn * axis1.Kvp + axis1.Dln * axis1.Kvi) + axis1.Rgn * axis1.Ktn * (axis1.Dln * axis1.fqs + axis1.Ksn * axis1.fwl) + axis1.Dln * axis1.Ksn + axis1.Rgn * axis1.Rgn * axis1.Dmn * axis1.Ksn) / (axis1.Rgn * axis1.Rgn * axis1.Jl_calc * axis1.Jmn);
  axis1.av0 = (axis1.Rgn * axis1.Rgn * axis1.Ktn * axis1.Ksn * axis1.Kvi) / (axis1.Rgn * axis1.Rgn * axis1.Jl_calc * axis1.Jmn);
  axis1.bv3 = (axis1.Rgn * axis1.Rgn * axis1.Ktn * axis1.Jl_calc * axis1.Kvp) / (axis1.Rgn * axis1.Rgn * axis1.Jl_calc* axis1.Jmn);
  axis1.bv2 = (axis1.Rgn * axis1.Rgn * axis1.Ktn * (axis1.Jl_calc * axis1.Kvi + axis1.Dln * axis1.Kvp)) / (axis1.Rgn * axis1.Rgn * axis1.Jl_calc * axis1.Jmn);
  axis1.bv1 = (axis1.Rgn * axis1.Rgn * axis1.Ktn * (axis1.Dln * axis1.Kvi + axis1.Ksn * axis1.Kvp)) / (axis1.Rgn * axis1.Rgn * axis1.Jl_calc * axis1.Jmn);
  axis1.bv0 = (axis1.Rgn * axis1.Rgn * axis1.Ktn * axis1.Ksn * axis1.Kvi) / (axis1.Rgn * axis1.Rgn * axis1.Jl_calc * axis1.Jmn);

  axis1.Kpp = (gsub[0].r1_pole * (axis1.av0 * axis1.bv1 - axis1.av1 * axis1.bv0)) / (gsub[0].r1_pole * (axis1.bv0 * axis1.bv2 - axis1.bv1 * axis1.bv1) + gsub[0].tau_pole * axis1.bv0 * (gsub[0].r1_pole * axis1.bv1 - gsub[0].tau_pole * axis1.bv0));
  axis1.apm0_pd = axis1.Kpp * axis1.bv0;
  axis1.apm1_pd = gsub[0].tau_pole * axis1.apm0_pd;
  axis1.apm2_pd = gsub[0].tau_pole * gsub[0].tau_pole * axis1.apm0_pd / (gsub[0].r1_pole);
  ...
  axis2.av4 = 1;
  axis2.av3 = (axis2.Rgn * axis2.Rgn * (axis2.Ktn * axis2.Jl_calc * (axis2.fwm + axis2.Kvp)) + axis2.Jmn * axis2.Dln + axis2.Jl_calc * axis2.Dmn) / (axis2.Rgn * axis2.Rgn * axis2.Jl_calc * axis2.Jmn);
  axis2.av2 = (axis2.Rgn * axis2.Rgn * axis2.Ktn * (axis2.Dln * axis2.fwm + axis2.Dln * axis2.Kvp + axis2.Jl_calc * axis2.Kvi) + axis2.Rgn * axis2.Ktn * axis2.Jl_calc * axis2.fqs + axis2.Jl_calc * axis2.Ksn + axis2.Rgn * axis2.Rgn * (axis2.Jmn * axis2.Ksn + axis2.Dmn * axis2.Dln)) / (axis2.Rgn * axis2.Rgn * axis2.Jl_calc * axis2.Jmn);
  axis2.av1 = (axis2.Rgn * axis2.Rgn * axis2.Ktn * (axis2.Ksn * axis2.fwm + axis2.Ksn * axis2.Kvp + axis2.Dln * axis2.Kvi) + axis2.Rgn * axis2.Ktn * (axis2.Dln * axis2.fqs + axis2.Ksn * axis2.fwl) + axis2.Dln * axis2.Ksn + axis2.Rgn * axis2.Rgn * axis2.Dmn * axis2.Ksn) / (axis2.Rgn * axis2.Rgn * axis2.Jl_calc * axis2.Jmn);
  axis2.av0 = (axis2.Rgn * axis2.Rgn * axis2.Ktn * axis2.Ksn * axis2.Kvi) / (axis2.Rgn * axis2.Rgn * axis2.Jl_calc * axis2.Jmn);
  axis2.bv3 = (axis2.Rgn * axis2.Rgn * axis2.Ktn * axis2.Jl_calc * axis2.Kvp) / (axis2.Rgn * axis2.Rgn * axis2.Jl_calc * axis2.Jmn);
  axis2.bv2 = (axis2.Rgn * axis2.Rgn * axis2.Ktn * (axis2.Jl_calc * axis2.Kvi + axis2.Dln * axis2.Kvp)) / (axis2.Rgn * axis2.Rgn * axis2.Jl_calc * axis2.Jmn);
  axis2.bv1 = (axis2.Rgn * axis2.Rgn * axis2.Ktn * (axis2.Dln * axis2.Kvi + axis2.Ksn * axis2.Kvp)) / (axis2.Rgn * axis2.Rgn * axis2.Jl_calc * axis2.Jmn);
  axis2.bv0 = (axis2.Rgn * axis2.Rgn * axis2.Ktn * axis2.Ksn * axis2.Kvi) / (axis2.Rgn * axis2.Rgn * axis2.Jl_calc * axis2.Jmn);

  axis2.Kpp = gsub[1].r1_pole * (axis2.av0 * axis2.bv1 - axis2.av1 * axis2.bv0) / (gsub[1].r1_pole * (axis2.bv0 * axis2.bv2 - axis2.bv1 * axis2.bv1) + gsub[1].tau_pole * axis2.bv0 * (gsub[1].r1_pole * axis2.bv1 - gsub[1].tau_pole * axis2.bv0));
  axis2.apm0_pd = axis2.Kpp * axis2.bv0;
  axis2.apm1_pd = gsub[1].tau_pole * axis2.apm0_pd;
  axis2.apm2_pd = gsub[1].tau_pole * gsub[1].tau_pole * axis2.apm0_pd / (gsub[1].r1_pole);
  ...
  axis3.av4 = 1;
  axis3.av3 = (axis3.Rgn * axis3.Rgn * (axis3.Ktn * axis3.Jl_calc * (axis3.fwm + axis3.Kvp)) + axis3.Jmn * axis3.Dln + axis3.Jl_calc * axis3.Dmn) / (axis3.Rgn * axis3.Rgn * axis3.Jl_calc * axis3.Jmn);
  axis3.av2 = (axis3.Rgn * axis3.Rgn * axis3.Ktn * (axis3.Dln * axis3.fwm + axis3.Dln * axis3.Kvp + axis3.Jl_calc * axis3.Kvi) + axis3.Rgn * axis3.Ktn * axis3.Jl_calc * axis3.fqs + axis3.Jl_calc * axis3.Ksn + axis3.Rgn * axis3.Rgn * (axis3.Jmn * axis3.Ksn + axis3.Dmn * axis3.Dln)) / (axis3.Rgn * axis3.Rgn * axis3.Jl_calc * axis3.Jmn);
  axis3.av1 = (axis3.Rgn * axis3.Rgn * axis3.Ktn * (axis3.Ksn * axis3.fwm + axis3.Ksn * axis3.Kvp + axis3.Dln * axis3.Kvi) + axis3.Rgn * axis3.Ktn * (axis3.Dln * axis3.fqs + axis3.Ksn * axis3.fwl) + axis3.Dln * axis3.Ksn + axis3.Rgn * axis3.Rgn * axis3.Dmn * axis3.Ksn) / (axis3.Rgn * axis3.Rgn * axis3.Jl_calc * axis3.Jmn);
  axis3.av0 = (axis3.Rgn * axis3.Rgn * axis3.Ktn * axis3.Ksn * axis3.Kvi) / (axis3.Rgn * axis3.Rgn * axis3.Jl_calc * axis3.Jmn);
  axis3.bv3 = (axis3.Rgn * axis3.Rgn * axis3.Ktn * axis3.Jl_calc * axis3.Kvp) / (axis3.Rgn * axis3.Rgn * axis3.Jl_calc * axis3.Jmn);
  axis3.bv2 = (axis3.Rgn * axis3.Rgn * axis3.Ktn * (axis3.Jl_calc * axis3.Kvi + axis3.Dln * axis3.Kvp)) / (axis3.Rgn * axis3.Rgn * axis3.Jl_calc * axis3.Jmn);
  axis3.bv1 = (axis3.Rgn * axis3.Rgn * axis3.Ktn * (axis3.Dln * axis3.Kvi + axis3.Ksn * axis3.Kvp)) / (axis3.Rgn * axis3.Rgn * axis3.Jl_calc * axis3.Jmn);
  axis3.bv0 = (axis3.Rgn * axis3.Rgn * axis3.Ktn * axis3.Ksn * axis3.Kvi) / (axis3.Rgn * axis3.Rgn * axis3.Jl_calc * axis3.Jmn);

  axis3.Kpp = gsub[2].r1_pole * (axis3.av0 * axis3.bv1 - axis3.av1 * axis3.bv0) / (gsub[2].r1_pole * (axis3.bv0 * axis3.bv2 - axis3.bv1 * axis3.bv1) + gsub[2].tau_pole * axis3.bv0 * (gsub[2].r1_pole * axis3.bv1 - gsub[2].tau_pole * axis3.bv0));
  axis3.apm0_pd = axis3.Kpp * axis3.bv0;
  axis3.apm1_pd = gsub[2].tau_pole * axis3.apm0_pd;
  axis3.apm2_pd = gsub[2].tau_pole * gsub[2].tau_pole * axis3.apm0_pd / (gsub[2].r1_pole);
...
void CalcTauLDyn(Robot axis[])
{
  ...
  axis1.tauLdyn_z2 = axis1.tauLdyn_z1;
  axis1.tauLdyn_z1 = axis1.tauLdyn;
  ...
  // 動力学外乱トルクの計算(3軸同時、簡略化) FB付きTm用、重力補償別計算
  axis1.tauLdyn_woG_z3 = axis1.tauLdyn_woG_z2;
  axis1.tauLdyn_woG_z2 = axis1.tauLdyn_woG_z1;
  axis1.tauLdyn_woG_z1 = axis1.tauLdyn_woG;
  axis1.tauLdyn_woG = H12 * axis2.al_calc + b122 * (axis2.wl_calc * axis2.wl_calc) + b112 * axis1.wl_calc * axis2.wl_calc + b113 * axis1.wl_calc * axis3.wl_calc;

  axis2.tauLdyn_woG_z3 = axis2.tauLdyn_woG_z2;
  axis2.tauLdyn_woG_z2 = axis2.tauLdyn_woG_z1;
  axis2.tauLdyn_woG_z1 = axis2.tauLdyn_woG;
  axis2.tauLdyn_woG = H21 * axis1.al_calc + H23 * axis3.al_calc + b211 * (axis1.wl_calc * axis1.wl_calc) + b233 * (axis3.wl_calc * axis3.wl_calc) + b223 * axis2.wl_calc * axis3.wl_calc;

  axis3.tauLdyn_woG_z3 = axis3.tauLdyn_woG_z2;
  axis3.tauLdyn_woG_z2 = axis3.tauLdyn_woG_z1;
  axis3.tauLdyn_woG_z1 = axis3.tauLdyn_woG;
  axis3.tauLdyn_woG = H32 * axis2.al_calc + b311 * (axis1.wl_calc * axis1.wl_calc) + b322 * (axis2.wl_calc * axis2.wl_calc);
